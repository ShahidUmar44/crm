...
import { MomentConfig, TimelineCalendar } from '@howljs/calendar-kit';
...
const Calendar = () => {
  ...
  const _renderCustomUnavailableItem = useCallback(props => <CustomUnavailableItem {...props} />, []);
  ...
  const _renderHalfLineCustom = useCallback(
    width => (
      <Svg>
        <Line x1="0" y1="1" x2={width} y2="1" stroke="#ececec" strokeDasharray={5} strokeWidth={2} />
      </Svg>
    ),
    [],
  );
